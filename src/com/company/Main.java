...
public class Main {
    public static Vector<CuptoareElectrice> vectorCuptoareElectrice() {
        CuptoareElectrice ce1 = new CuptoareElectrice("Cuptoare Electrice", 599.99f, true, "CEA-4520DBL", "Star-Light",
                ...
                230);
        CuptoareElectrice ce2 = new CuptoareElectrice("Cuptoare Electrice", 235.03f, true, "Floria-2898", "Floria",
                "4.3", "Prajire, Coacere, Patiserie, Rumenire", "Negru", "Termostat, Indicator luminos", 1500, 320);
        CuptoareElectrice ce3 = new CuptoareElectrice("Cuptoare Electrice", 333.20f, true, "ZLN-3130", "ZILAN", "4.3",
                "Sotare, Coacere, Gratinat, Patiserie, Rumenire", "Gri", "Oprire automata, Termostat, Semnal acustic",
                1300, 300);
        CuptoareElectrice ce4 = new CuptoareElectrice("Cuptoare Electrice", 399.99f, true, "CEA-3016CBL", "Star-Light",
                "4,8", "Prajire, Grilling, Convectie, Coacere", "Negru",
                "Oprire automata, Iluminare, Timer, Termostat, Semnal acustic, Indicator luminos", 1600, 230);
        CuptoareElectrice ce5 = new CuptoareElectrice("Cuptoare Electrice", 234.99f, false, "A28B2", "Albatros", "4.8",
                "Prajire, Frigere, Coacere", "Negru", "Semnal acustic", 1500, 230);
        CuptoareElectrice ce6 = new CuptoareElectrice("Cuptoare Electrice", 449.00f, true, "Express Air Fry 26095-56",
                "Russell Hobbs", "5", "Prajire, Convectie, Coacere", "Argintiu", "Timer, Mentinere la cald", 1500, 220);
        CuptoareElectrice ce7 = new CuptoareElectrice("Cuptoare Electrice", 338.00f, true, "CS45B2", "Samus", "4.6",
                "Coacere", "Negru", "Semnal acustic", 2000, 230);
        CuptoareElectrice ce8 = new CuptoareElectrice("Cuptoare Electrice", 159.90f, true, "MN-1009", "MUHLER", "0",
                "Frigere", "Negru", "Timer", 650, 230);
        CuptoareElectrice ce9 = new CuptoareElectrice("Cuptoare Electrice", 249.00f, true, "HarlemÂ® Rustic", "Harlem",
                "3.8", "Prajire, Coacere, Patiserie", "Visiniu", "Termostat", 1300, 320);
        CuptoareElectrice ce10 = new CuptoareElectrice("Cuptoare Electrice", 849.01f, true, "42814", "Gastroback", "5",
                "Grilling, Convectie, Coacere", "Negru/Inox", "Oprire automata, Iluminare, Timer, Termostat", 1500,
                230);
    ...
    public static Vector<CuptoareMicrounde> vectorCuptoareMicrounde() {
        CuptoareMicrounde cm1 = new CuptoareMicrounde("Cuptoare cu Microunde", 256.99f, true, "KOR-6S20W", "Daewoo",
                "4.5", "Standard", "Mecanic", "Microunde", "Alb", "Timer, Pornire intarziata, Interior neaderent");
        CuptoareMicrounde cm2 = new CuptoareMicrounde("Cuptoare cu Microunde", 229.99f, true, "AMG17M70VH", "Hansa",
                "4.5", "Standard", "Mecanic", "Microunde", "Alb",
        ...
        CuptoareMicrounde cm4 = new CuptoareMicrounde("Cuptoare cu Microunde", 309.00f, true, "20MWS-706M/B", "BBK",
                "0", "Standard", "Digital", "Microunde", "Negru", "Timer, Semnal sonor la finalizarea programului");
        CuptoareMicrounde cm5 = new CuptoareMicrounde("Cuptoare cu Microunde", 319.99f, true, "HMW-20GRD", "HEINNER",
                "4.7", "Standard", "Digital", "Microunde, Grill", "Rosu",
                "Timer, Blocare acces copii, Semnal sonor la finalizarea programului");
        CuptoareMicrounde cm6 = new CuptoareMicrounde("Cuptoare cu Microunde", 329.99f, true, "ZFM20100SA", "Zanussi",
                "4.8", "Standard", "Mecanic", "Microunde", "Argintiu",
                "Timer, Iluminare interioara, Semnal sonor la finalizarea programului");
        CuptoareMicrounde cm7 = new CuptoareMicrounde("Cuptoare cu Microunde", 349.99f, false, "KOR-669RC", "Daewoo",
                "4.8", "Standard", "Digital", "Microunde", "Crem",
                "Oprire automata, Timer, Blocare acces copii, Semnal sonor la finalizarea programului, Mod Eco, Auto cook");
        CuptoareMicrounde cm8 = new CuptoareMicrounde("Cuptoare cu Microunde", 354.99f, true, "MM2005/RD", "Oursson",
                "5", "Standard", "Mecanic", "Microunde", "Rosu", "Timer, Functie de decongelare");
        CuptoareMicrounde cm9 = new CuptoareMicrounde("Cuptoare cu Microunde", 375.90f, true, "FMO-2073BS", "Finlux",
                "4.5", "Standard", "Mecanic", "Microunde", "Negru/Argintiu", "Iluminare interioara");
        CuptoareMicrounde cm10 = new CuptoareMicrounde("Cuptoare cu Microunde", 379.99f, true, "MO20E1S", "Gorenje",
                "4.8", "Standard", "Digital", "Microunde", "Argintiu",
    ...
    public static void main(String[] args) {
        ...
        CafetieraFiltru c = new CafetieraFiltru("Cafetiera cu Filtru", 709.90f, true, "Grind&Brew HD7769", "PHILIPS",
                "5 stele", "Negru", "Macinata/Boabe");
        ...
        CafetieraFiltru cfil = new CafetieraFiltru("Cafetiera", 293.34f, true, "MY4444", "MYRIA", "No Reviews", "Gri",
                "Boabe/Macinata");
        System.out.println(cfil + "\b");

        Espressor e = new Espressor("Espressor", 1499.99f, true, "Magnifica S", "DE LONGHI", "4.5 stele", "Negru", 1480,
                "Boabe/Macinata");
        System.out.println(e + "\n");
        Espressor e2 = new Espressor("Espressor", 2559.90f, true, "Seria 4300 EP4349/70", "Philips", "4.95 stele",
                "Negru", 1500f, "Boabe");
        System.out.println(e2 + "\n");
        Espressor e3 = new Espressor("Espressor", 405.93f, true, "Genio S Touch ", "Krups", "5 stele", "Argintiu", 1500,
                "Capsule");
        ...
        MasinaSpalatRufe r1 = new MasinaSpalatRufe("Masini de spalat rufe", 5500.99f, true, "ghfs56", "Arctic", "4.5",
                "incorporat", "LED", "A+", 12, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r2 = new MasinaSpalatRufe("Masini de spalat rufe", 4500.99f, true, "ghfs56", "Beko", "4.2",
                "incorporat", "LED", "A++", 15, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r3 = new MasinaSpalatRufe("Masini de spalat rufe", 3123.99f, false, "ghfs56", "Whirlpool",
                "3.5", "incorporat", "LCD", "A+", 10, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r4 = new MasinaSpalatRufe("Masini de spalat rufe", 3213.99f, true, "ghfs56", "Samsung", "1.5",
                "incorporat", "LED", "A+++", 6, "Spalare la 30grade, Spalare la 800 rpm");
        ...
        MasinaSpalatRufe r6 = new MasinaSpalatRufe("Masini de spalat rufe", 3263.99f, false, "ghfs56", "BOSCH", "4.78",
                "incorporat", "LCD", "A++", 12, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r7 = new MasinaSpalatRufe("Masini de spalat rufe", 6574.99f, true, "ghfs56", "Electrolux",
                "3.12", "incorporat", "LED", "A+", 7, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r8 = new MasinaSpalatRufe("Masini de spalat rufe", 6456.99f, true, "ghfs56", "Gorenje", "2.89",
                "incorporat", "LCD", "A+", 20, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r9 = new MasinaSpalatRufe("Masini de spalat rufe", 3567.99f, false, "ghfs56", "Candy", "4.89",
                "incorporat", "LED", "A+++", 16, "Spalare la 30grade, Spalare la 800 rpm");
        MasinaSpalatRufe r10 = new MasinaSpalatRufe("Masini de spalat rufe", 8755.99f, true, "ghfs56", "Indesit", "5",
                "incorporat", "LED", "A+", 12, "Spalare la 30grade, Spalare la 800 rpm");
        ...
        MasinaSpalatVase v2 = new MasinaSpalatVase("Masini de spalat vase", 3853.99f, true, "ajdh49871", "Arctic", "3",
                "incorporat", "LED", "A++", 2, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v3 = new MasinaSpalatVase("Masini de spalat vase", 7498.99f, false, "ajdh49871", "Whirlpool",
                "3", "incorporat", "LCD", "A+", 3, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v4 = new MasinaSpalatVase("Masini de spalat vase", 2212.99f, true, "ajdh49871", "Samsung", "3",
                "incorporat", "LED", "A+", 6, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v5 = new MasinaSpalatVase("Masini de spalat vase", 7437.99f, true, "ajdh49871", "LG", "3",
                "incorporat", "LCD", "A+++", 5, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v6 = new MasinaSpalatVase("Masini de spalat vase", 4276.99f, false, "ajdh49871", "BOSCH", "3",
                "incorporat", "LCD", "A+", 10, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v7 = new MasinaSpalatVase("Masini de spalat vase", 7792.99f, true, "ajdh49871", "Gorenje", "3",
                "incorporat", "LED", "A+", 8, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v8 = new MasinaSpalatVase("Masini de spalat vase", 7420.99f, true, "ajdh49871", "Candy", "3",
                "incorporat", "LCD", "A++", 6, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v9 = new MasinaSpalatVase("Masini de spalat vase", 5998.99f, false, "ajdh49871", "Indesit",
                "3", "incorporat", "LED", "A+", 3, "Spalare rapida, Spalare  cu temperatura scazuta");
        MasinaSpalatVase v10 = new MasinaSpalatVase("Masini de spalat vase", 4898.99f, true, "ajdh49871", "Electrolux",
                "3", "incorporat", "LCD", "A+++", 7, "Spalare rapida, Spalare  cu temperatura scazuta");
        ...
        Frigider f2 = new Frigider("Frigorifice", 1091.99f, true, "AK54305M30MT", "Arctic", "4.8 stele", "Standard",
                "Fara", "F");
        Frigider f3 = new Frigider(f2);
        LadaFrigorifica lf1 = new LadaFrigorifica();
        LadaFrigorifica lf2 = new LadaFrigorifica("Frigorifice", 1149.99f, true, "HCF-H205A+", "Heinner", "4.63 stele",
                "A+", "Alb");
